package com.tony.analysis.service

import android.util.Log
import com.jakewharton.retrofit2.adapter.rxjava2.RxJava2CallAdapterFactory
import com.tony.analysis.Tracker
import com.tony.analysis.data.TrackerEvent
import com.tony.analysis.data.TrackerMode
import com.tony.analysis.db.EventContract
import com.tony.analysis.db.database
import com.tony.analysis.utils.GSON
import com.tony.analysis.utils.encodeBASE64
import com.tony.analysis.utils.urlEncode
                ...
                transaction {
                    events.forEach {
                        insert(EventContract.TABLE_NAME, EventContract.DATA to GSON.toJson(it),
                                EventContract.TIME to it.start_time)
                    }
                }
            }
        }
